  ...
  url: 'https://hajikhansahito110786.github.io',
      ...
      ['classic',
        {
          docs: {
            ...
            editUrl:
              'https://github.com/hajikhansahito110786/physicalAIbookas/tree/main/',
          },
          blog: {
    ...
    themeConfig: {
      ...
      metadata: [
        ...
        {name: 'og:image', content: 'https://hajikhansahito110786.github.io/physicalAIbookas/img/docusaurus-social-card.jpg'},
        {name: 'twitter:card', content: 'summary_large_image'},
        {name: 'twitter:image', content: 'https://hajikhansahito110786.github.io/physicalAIbookas/img/docusaurus-social-card.jpg'},
      ],
      colorMode: {
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/hajikhansahito110786/physicalAIbookas',
            label: 'GitHub',
            position: 'right',
          },
        ],
