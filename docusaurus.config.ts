...
const config: Config = {
  ...
  projectName: 'gemini', // Usually your repo name.
  ...
  themeConfig: {
    ...
    metadata: [
      ...
      {name: 'og:image', content: 'https://your-github-username.github.io/gemini/img/docusaurus-social-card.jpg'},
      {name: 'twitter:card', content: 'summary_large_image'},
      {name: 'twitter:image', content: 'https://your-github-username.github.io/gemini/img/docusaurus-social-card.jpg'},
    ],
    colorMode: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/your-github-username/gemini',
          label: 'GitHub',
          position: 'right',
        },
      ],
